REPORT z_abptrain_acm_exer51.

**************************************************************************************
**************************************************************************************
*Report Name: Z_ABPTRAIN_ACM_EXER51
*Report Title: Calculator OOP and Overloading Constructor
*User: Aaron Miller
*Date: 4/10/2019
...
**Copy Ex 3.1 (50)
**X Add Modulo function
**X   -Add new checkbox for modulo in selection-screen
**X   -Add operation class for modulo
**X Create and overloading constructor
**X   -Check if both integers have value
**X   -Check if checkbox for class (add, sub, etc) is abap_true
**************************************************************************************
**************************************************************************************
...
*Constructor load for value validation on user input
  METHOD constructor.
*this will validate that user inputed numbers for parameters
