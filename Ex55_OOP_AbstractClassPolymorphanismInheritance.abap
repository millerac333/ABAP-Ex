REPORT Z_ABPTRAIN_ACM_EXER55.

**************************************************************************************
**************************************************************************************
*Report Name: Z_ABPTRAIN_ACM_EXER55
*Report Title: OOP - Abstract Classes - Polymorphanism with Inheritance
*User: Aaron Miller
*Date: 4/30/2019

*OVERVIEW
*-Copy Exercise 54
*-Change Calculator class to an Abstact Class
*-Modify program so that it will inherit from abstract class
